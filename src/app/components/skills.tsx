  ...
  const cards = skills.map((skill, index) => (
    ...
    >
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-white/60">Used to ship resilient, accessible interfaces.</p>
      </div>
    </div>
  ));

  return (
    <section id="skills" className="relative isolate overflow-hidden bg-slate-950 py-24 sm:py-32">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/65">
            From rapid prototyping to production systems, these are the languages, frameworks, and tools that keep shipping velocity high without sacrificing quality.
          </p>
        </div>
