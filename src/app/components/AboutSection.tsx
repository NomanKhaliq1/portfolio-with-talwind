  ...
  const pillars = [
    {
      ...
      description: "TypeScript, React, Next.js, Tailwind, Framer Motion",
      icon: Code2,
    },
    {
      title: "Backend foundations",
      description: "Node.js, PHP & WordPress, Python, REST",
      icon: Server,
    },
    {
      title: "Data layer",
          ...
          <div className="order-2 space-y-10 lg:order-1">
            <div className="space-y-5">
              ...
              <h2 className="text-3xl font-semibold text-slate-900 sm:text-4xl">
                A calm partner for teams shipping purposeful digital products.
              </h2>
              <p className="text-lg leading-relaxed text-slate-600">
                I blend product strategy, interface design, and engineering to help teams move from vision to launch. Whether embedded with a startup or collaborating with an in-house crew, I focus on clarity, momentum, and systems that scale.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-3xl border border-white/60 bg-white p-6 shadow-sm shadow-sky-500/5">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  Scaling design systems, inclusive motion, and performance budgets that keep products fast as they grow.
                </p>
              </div>
            </div>
            ...
            <p className="text-sm font-medium text-slate-700">
              Focused on long-term collaborations where thoughtful design and engineering craftsmanship matter.
            </p>
          </div>
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] border border-white/70 bg-white/80 p-5 shadow-xl shadow-slate-900/10 backdrop-blur">
                ...
                <div className="mx-auto -mt-10 w-[85%] rounded-3xl border border-white/70 bg-white p-6 text-left shadow-lg shadow-slate-900/5">
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-slate-600">
                    <li>Partnered on 8+ product launches from discovery through growth.</li>
                    <li>Designs with accessibility, performance, and maintainability front-of-mind.</li>
                    <li>Comfortable facilitating workshops and aligning multi-disciplinary teams.</li>
                  </ul>
                </div>
              </div>
